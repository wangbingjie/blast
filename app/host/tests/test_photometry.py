...
# TaskRegister.objects.filter(transient__name='2010h')[5]
...
class PhotometryTest(TestCase):
    ...
    def setUp(self):
        ...
        self.aperture_photometry = GlobalAperturePhotometry()
    ...
    def test_aperture_photometry(self):
        ...
        status = self.aperture_photometry._run_process(transient)
