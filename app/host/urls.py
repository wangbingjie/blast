...
urlpatterns = [
    ...
    path(f"""{base_path}download_chains/<slug:slug>/<str:aperture_type>/""", views.download_chains,name='download_chains'),
    path(f"""{base_path}download_modelfit/<slug:slug>/<str:aperture_type>/""", views.download_modelfit,name='download_modelfit'),
    path(f"""{base_path}download_percentiles/<slug:slug>/<str:aperture_type>/""", views.download_percentiles,name='download_percentiles'),
    ...
    path(f"""{base_path}reprocess_transient/<slug:slug>""", views.reprocess_transient,name='reprocess_transient'),
    path(f"""{base_path}report_issue/<item_id>""", views.report_issue,name='report_issue'),
    path(f"""{base_path}resolve_issue/<item_id>""", views.resolve_issue,name='resolve_issue'),
]
